...
public class Ransac {
    public static void analyse(Image imageA, Image imageB, double r, double R, int iterations, float difference, boolean perspective) {
    ...
    private static Transform findBestModel(Image imageA, double r, double R, int iterations, boolean perspective) {
    ...
    private static Poly randomPoly(Image imageA, double r, double R, boolean perspective) {
    ...
    private static void removeFarPoints(ArrayList<Point> copyPoints, Point firstPoint, Point secondPoint, Point thirdPoint, double r, double R) {
    ...
    private static boolean passTest(double x1, double y1, double x2, double y2, double r, double R) {
